...
public class MetricsInitializer {
    ...
    private de.example.backupmonitor.s3.S3CheckResult toS3CheckResult(S3CheckResultEntity e) {
        return de.example.backupmonitor.s3.S3CheckResult.builder()
                ...
                .bucket(e.getBucket())
                .bucketAccessible(e.isBucketAccessible())
                .exists(e.isExists())
                ...
                .compression(e.isCompression())
                .sizeShrinkWarning(e.isSizeShrinkWarning())
                .sizeGrowthWarning(e.isSizeGrowthWarning())
                .executionTimeMs(e.getExecutionTimeMs() != null ? e.getExecutionTimeMs() : 0L)
                .durationGrowthWarning(e.isDurationGrowthWarning())
                .s3FileCount(e.getS3FileCount())
